...
describe('createReducerActions', () => {
  it('should create actions for a flat reducer', () => {
    ...
    actions.increment().should.eql({ type: 'increment', payload: undefined })
    actions.decrement().should.eql({ type: 'decrement', payload: undefined })
  ...
  it('should create actions for a nested reducer', () => {
    ...
    actions.counter.increment().should.eql({ type: 'counter.increment', payload: undefined })
    actions.counter.decrement().should.eql({ type: 'counter.decrement', payload: undefined })
