...
exports.default = function (_ref) {
  ...
  return (0, _redux.createStore)(reducer, initialState, (0, _redux.compose)(_redux.applyMiddleware.apply(undefined, [_reduxThunk2.default].concat((0, _toConsumableArray3.default)(middleware))), devtools));
};
